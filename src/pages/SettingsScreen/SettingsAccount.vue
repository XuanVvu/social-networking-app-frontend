...
<template>
  ...
  <settings-screen-common label="Thông tin cá nhân">

    <el-form class="flex flex-col gap-3 account-information" ref="ruleFormRef" status-icon :model="form"
      ...
      <el-form-item prop="description" label="Ảnh đại diện">
        <div>
          <el-upload v-model:file-list="fileList" :auto-upload="false" list-type="picture-card" :limit="1"
...
<style lang="scss">
.account-information .el-form-item__label {
  width: 100px;
