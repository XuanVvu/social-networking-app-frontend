...
const rules = reactive<FormRules<RuleForm &{confirmPassword: string; firstName: string; lastName: string }>>({
    firstName: [
        { required: true, message: 'Vui lòng nhập firstName', trigger: 'blur' },
    ],
    lastName: [
        { required: true, message: 'Vui lòng nhập lastName', trigger: 'blur' },
    ],
    email: [
            ...
            <div class="flex flex-col justify-center w-1/2 p-20">
                ...
                <el-form class="flex flex-col gap-3" ref="ruleFormRef" :rules="rules" :model="form" :size="formSize"
                    ...
                    <el-form-item prop="confirmPassword">
                        <InputBase type="password" placehoder="Nhập lại mật khẩu" v-model="form.confirmPassword" :icon="Lock" />
                    </el-form-item>
